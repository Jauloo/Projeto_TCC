...
public class AtualmenteNPCQuiz : MonoBehaviour
{
    ...
    public AtualmenteQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento do PRESENTE E FUTURO." +
                "Chegamos a um tempo em que os sistemas abertos estão em toda parte."+
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.AtualmenteCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento do Presente e Futuro. "+
            "\n\nAgora volte por aquele portal e finalize sua atualização de conhecimento.";
        }
