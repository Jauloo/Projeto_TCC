...
public class UbuntuNPCQuiz : MonoBehaviour
{
    ...
    public UbuntuQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento Ubuntu." +
                "Trago o espírito de acessibilidade, união e simplicidade para o mundo open source."+
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.UbuntuCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento Ubuntu. "+
