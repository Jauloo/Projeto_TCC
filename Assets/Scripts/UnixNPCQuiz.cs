...
public class UnixNPCQuiz : MonoBehaviour
{
    ...
    public UnixQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento UNIX. " +
                "Protejo o conhecimento sobre o começo de uma era. " +
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.UnixCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento UNIX. "+
