...
public class AndroidNPCQuiz : MonoBehaviour
{
    ...
    public AndroidQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento Android." +
                "Um sistema livre que levou o código aberto para o bolso de bilhões de pessoas."+
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.AndroidCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento Android. "+
