...
public class BSDNPCQuiz : MonoBehaviour
{
    ...
    public BSDQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento BSD." +
                "O BSD nasceu como uma derivação do UNIX, mas trouxe grandes avanços de portabilidade e estabilidade."+
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.BSDCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento BSD. "+
