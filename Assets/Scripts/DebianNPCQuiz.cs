...
public class DebianNPCQuiz : MonoBehaviour
{
    ...
    public DebianQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento Debian." +
                "Um sistema criado por e para a comunidade, que se tornou base de muitos outros."+
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.DebianCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento Debian. "+
