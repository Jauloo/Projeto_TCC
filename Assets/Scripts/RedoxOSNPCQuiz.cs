...
public class RedoxOSNPCQuiz : MonoBehaviour
{
    ...
    public RedoxOSQuizManager quizManager;
    ...
    void Update()
    {
        ...
        if (!dialoguePanel.activeSelf && Input.GetKeyDown(KeyCode.F))
        {
            ...
            dialogueText.text =
                "Sou o guardião do fragmento Redox." +
                "Um novo experimento open source que une segurança e inovação em código moderno."+
    ...
    public void OnQuizSucceeded()
    {
        ...
        GameState.RedoxOSCompleted = true;
        if (dialoguePanel != null && dialogueText != null)
        {
            dialoguePanel.SetActive(true);
            dialogueText.text = "Parabéns! Você respondeu corretamente todas as perguntas do fragmento Redox. "+
